...
(export '#.(lispify "_EVENT_PACKAGE" 'constant))
(export '#.(lispify "_EVENT_PACKAGE_BUGREPORT" 'constant))
(export '#.(lispify "_EVENT_PACKAGE_NAME" 'constant))
(export '#.(lispify "_EVENT_PACKAGE_STRING" 'constant))
(export '#.(lispify "_EVENT_PACKAGE_TARNAME" 'constant))
(export '#.(lispify "_EVENT_PACKAGE_URL" 'constant))
(export '#.(lispify "_EVENT_PACKAGE_VERSION" 'constant))
...
(export '#.(lispify "LIBEVENT_VERSION" 'constant))
