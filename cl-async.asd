...
(asdf:defsystem cl-async
  ...
  ((:file "package")
   ...
   (:file "streamish" :depends-on ("package" "event-loop" "event"))
   (:file "tcp" :depends-on ("dns" "streamish"))
   (:file "tcp-stream" :depends-on ("tcp"))
   (:file "signal" :depends-on ("package" "streamish"))
   (:file "notify" :depends-on ("package" "streamish"))
   (:file "poll" :depends-on ("package" "streamish"))
